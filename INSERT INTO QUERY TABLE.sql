...
('Vishaa','Sandakolizhi','Vishu',DATEADD(dd,+6,GETDATE())),
('Rajni','Santhramugi','Rajini',DATEADD(dd,+7,GETDATE())),
('Ajih','Veeram','Ahith',DATEADD(dd,+8,GETDATE())),
('Viay','Bathri','Vijay',DATEADD(dd,+9,GETDATE())),
('Srya','7 th sense','Surya',DATEADD(dd,+10,GETDATE())),
('Karhik','anegan','karthi',DATEADD(dd,+11,GETDATE()));
